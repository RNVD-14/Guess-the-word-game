...
def start_main_page():
    def start_game(args):
        ...
        if args == 1:
            ...
            Animals.main()
        #elif args == 2:from Options import Body_parts Body_parts.main()
        elif args == 3:
            ...
            from Options import Mobile
            Mobile.main()
        elif args==9:
            from Options import Instruction
            Instruction.main()
        elif args==10:
            from Options import Places
            Places.main()
    ...
    def option():
        ...
        sel_btn10= Button(
            ...
            bg="#99ffd6",
            cursor="hand2",
            command=lambda: start_game(10),
        )
        lab_img1.grid(row=0, column=0, padx=20)
        sel_btn9.grid(row=0, column=4, pady=(10, 0), padx=50, )
        sel_btn1.grid(row=9, column=4, pady=(10, 0), padx=50, )
        #sel_btn2.grid(row=8, column=4, pady=(10, 0), padx=50, )
        ...
        sel_btn7.grid(row=7, column=4, pady=(10, 0), padx=50, )
        sel_btn8.grid(row=2, column=4, pady=(10, 0), padx=50, )
        sel_btn10.grid(row=1, column=4, pady=(10, 0), padx=50, )
